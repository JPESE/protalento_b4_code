...
/*6.Crea una función que reciba como argumento una variable de cualquier tipo y un callback. La función debe retornar como resultado, mediante un callback, cual es el tipo de dato de la variable ingresada e imprimir su contenido.*/
//callback(`La variable es de tipo: ${ } y su contenido es ${ }`)